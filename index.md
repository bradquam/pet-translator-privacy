...
**We do not collect, store, or transmit any personal information to our own servers.** The App operates primarily on your device.
...
- **User preferences** (e.g., HD voice toggle) via SharedPreferences
- **API key** (if you provide your own) via encrypted secure storage
...
The App may be used by children under the age of 13. We are committed to complying with the Children's Online Privacy Protection Act (COPPA).
...
If you are a parent or guardian and believe that your child has provided personal information through the App, please contact us at the email address below. We will promptly investigate and delete any such information if found.
...
When you tap the "Share" button, the App uses your device's native share sheet to let you share content via your chosen method (text message, social media, etc.). This sharing is initiated and controlled entirely by you through your device's operating system. We have no access to or control over how shared content is handled by third-party platforms.

## Data Security

Since we do not collect or store personal data on external servers, there is minimal risk of a data breach from our end. Local data stored on your device is protected by your device's built-in security features, including encrypted secure storage for any API keys.
...
*This privacy policy applies to the Pet Personality Translator app available on the Apple App Store and Google Play Store.*
